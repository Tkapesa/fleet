...
const LOGO_STRIPE =
  'https://a.storyblok.com/f/337048/1130x140/8e14227e2e/logo-stripe.png'

const FIELD =
  'w-full border-0 border-b border-white/35 bg-transparent pb-2.5 pt-1 text-[15px] text-white outline-none placeholder:text-white/35 focus:border-[#ABFF02]'
  ...
  return (
    <section id="contact" className="relative z-10 isolate bg-white text-[#052424]">
      <div className="mx-auto max-w-[1280px] px-6 pb-6 pt-16 sm:px-8 sm:pt-20 lg:px-10 lg:pt-24">
        <h2 className="mx-auto max-w-4xl text-center font-head text-[clamp(32px,4.6vw,52px)] font-semibold leading-[1.12] tracking-[-0.02em] text-[#052424]">
        ...
        <div className="mt-12 grid items-start gap-10 lg:mt-16 lg:grid-cols-[1fr_1.15fr] lg:gap-14">
          ...
          <div className="max-w-xl pt-1">
            <p className="text-[16px] leading-relaxed text-[#1f1f1f]">
              Fill out the form, and we&apos;ll be happy to discuss how Terminal can help you with your yard of the
              future:
            </p>
            ...
            <img
              ...
              className="mt-4 w-full max-w-[520px] object-contain object-left"
              loading="lazy"
            />
          </div>
          ...
          {/* Dark form card */}
          <form
            className="rounded-[18px] bg-[#052424] p-6 text-white sm:p-8 lg:p-9"
            onSubmit={(e) => {
              e.preventDefault()
            }}
          >
            <div className="grid gap-x-8 gap-y-7 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative">
                  ...
                  <span className="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 text-white/50" aria-hidden="true">
                    ▾
                  </span>
                </div>
              </div>
            ...
            <button
              type="submit"
              disabled={!canSubmit}
              className="mt-9 w-full rounded-[4px] bg-[#1a3333] py-4 text-[12px] font-bold uppercase tracking-[0.14em] text-white transition enabled:hover:bg-[#052424] enabled:hover:text-[#ABFF02] disabled:cursor-default disabled:opacity-55"
            >
              Submit
            </button>
          </form>
